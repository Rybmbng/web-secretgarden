...
class RoleResource extends Resource implements HasShieldPermissions
{
    ...
    {
        return Menu::where('resource', static::class)->value('icon') ?? 'heroicon-o-shield-check';
    }
    ...
    {
        $isVisible = Menu::where('resource', static::class)->value('is_visible');
        return is_null($isVisible) ? true : (bool) $isVisible;
    }
